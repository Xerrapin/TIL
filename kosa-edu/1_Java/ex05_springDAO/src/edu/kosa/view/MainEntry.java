...
public class MainEntry { // View
	public static void main(String[] args) throws Exception { // 예외 위임
		...
		case 2: dao.selectAll();
			break;
			
		case 3: System.out.println("gno select call");
			break;
			
		case 4: System.out.println("update call");
			break;
			
		case 5: System.out.println("delete call");
			break;
		...
		default: System.out.println("없는 번호입니다. 1~6중에서 선택하세요.");
			break;
		}
